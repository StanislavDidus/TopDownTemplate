...
public:
	...
	void PrintScaled(char* a_String, int x1, int y1, float scaleX, float scaleY, int width, Pixel color);
...
public:
	...
	void DrawScaled( int a_X, int a_Y, int a_Width, int a_Height, Surface* a_Target, bool flipped = false);
